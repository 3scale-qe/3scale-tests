...
DASHBOARDS = [
    ...
    pytest.param(
        ...
        marks=pytest.mark.skipif(
            TESTED_VERSION >= Version("2.13"), reason="This Dashboard is not applicable to this 3scale version"
        ),
    ),
    pytest.param(
        "kubernetes-resources-by-namespace",
    ...
    ("zync", "sum(rate(rails_requests_total{namespace='$namespace',pod=~'zync-[a-z0-9]+-[a-z0-9]+'}[1m])) by (status)"),
]
