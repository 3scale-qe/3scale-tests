...
@pytest.fixture(scope="module")
def toolbox_copy(service, my_applications_plans, my_activedoc, product_service):
...
def toolbox_update(service, modify_product, product_service, dst_product, modify_methods,
    ...
    update_cmd += f" -s {constants.THREESCALE_SRC1} -d {constants.THREESCALE_DST1} {service['id']}"
