...
def check_metrics():
    ...
    toolbox.check_object(out_variables["metric1"], attr_list, ["metric1 desc", "metric1", "metric1", "metric1", "hit"])
    toolbox.check_object(
        out_variables["metric_system"],
        attr_list,
        ["metric2 desc", "metric_system", "metric_system", "metric2", "apple"],
    )
    toolbox.check_object(
        out_variables["metric3"], attr_list, ["metric1 desc", "metric_system", "metric3", "metric_system", "hit"]
    )
