...
from testsuite.utils import fallback
...
class Realm:
    ...
    def __init__(self, master: KeycloakAdmin, name, verify=None) -> None:
        self.verify = fallback(verify, settings["ssl_verify"])
    ...
    def create_client(self, name, cert=None, verify=None, **kwargs):
        ...
        return Client(self, client_id, cert, fallback(verify, self.verify))
    ...
    def oidc_client(self, client_id, client_secret, cert=None, verify=None) -> KeycloakOpenID:
        ...
        return KeycloakOpenID(
            ...
            cert=cert,
            verify=fallback(verify, self.verify),
        )
...
class RHSSO:
    ...
    def create_realm(self, name: str, verify=None, **kwargs) -> Realm:
        ...
        return Realm(self.master, name, verify=fallback(verify, self.verify))
