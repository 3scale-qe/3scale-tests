...
class ContainerConfig:
    ...
    def __init__(self, image: str, tag: str = "latest", env: Optional[Dict[str, str]] = None,
                 ports: Optional[Dict[str, str]] = None, volumes: Optional[Dict[str, Dict[str, str]]] = None,
                 entrypoint: Optional[str] = None, cmd: Optional[List[str]] = None, detach: bool = True):
